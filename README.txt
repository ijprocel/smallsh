This project is a stripped-down shell that implements a subset of features of well-known shells. This was a class project, with the following features required to be implemented:
...
For more details about the requirements, see below.
